...
const listaHorasDevidas = document.getElementById('lista-horas-devidas');
...
function showToast(message, type = 'info') {
  ...
  // Toca o som de notificação (se houver)
  // const notificationSound = new Audio('js/notification.mp3'); // Assuming path is correct
